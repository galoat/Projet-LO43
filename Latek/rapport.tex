...
Il s'agit d'un thread qui possédé un trajet, chaque voiture possède un identifiant unique donner par la classe "flotte de véhicule" et stoker  dans un integer "identifiant", de plus lors de l'instanciation de cette classe on lui assigne le trajet donner par le passager.
